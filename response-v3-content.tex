...
\bigskip
  ...
  \REVIEW{PROGRESS} {Submit the point-by-point response to the
    ...
    which we used. We will change this and introduce a PDF file
    instead, which is easier for us also.}

  \REVIEW{PROGRESS} {Submit the point-by-point response to the
    reviewer's comments and my comments in a pdf file.}
  {The original submisison web page had a field to enter the comments
    as text which we used. We will change this and introduce a PDF
    file instead, which is easier for us also.}
