...
the reporting \cite{Petropoulos2020-hh}. Initial fears about COVID-19
...
associations, and predict outcomes \cite{Ting2020-lw}.  In addition to
...
\cite{Pyne2015-ao}. Several organizations, including the Johns Hopkins
...
lives \cite{www-cdc-modeling-forecast}.
...
underlying prediction, as shown in Fig. \ref{fig:magic-1}. Such model
...
unique covariates. We looked at two related ways of doing this:

\begin{description}

\item [(a)] Have covariates fixed in time (static)

\item[(b)] Multiply the covariates by the times series (we used the
  average of cases and deaths)
