...
\begin{requirement}{\bf Compute Resource Mapping.}
  ...
  \citep{las-19-nist}. This includes containers but also infrastructure
...
integrator
\citep{cloudmesh-openapi-install,cloudmesh-openapi-benchmark,cloudmesh-manual}. Additionally,
...
the large-scale longitudinal CDC BRFSS surveys \citep{www-cdc-brfss},
...
data compiled by NCHS \citep{www-cdc-nchs} and integrate them with
other data sources.
...
New York Times~\citep{github-nytimes} and the Johns Hopkins Coronavirus
Resource Center~\citep{www-jh-covid19}.  For this study, we generated
